...
* Remove the `Dictionary` type sugar in favor of using `Record` directly [Pagan Gazzard]
...
* Convert lodash get usage to native equivalent [Pagan Gazzard]

## 10.0.5 - 2026-01-12

* Replace some lodash usage with native alternatives [Matthew Yarmolinsky]
